...
'''
input_file = open("need_hashes2.csv", "r")
rdr = csv.DictReader(input_file, fieldnames=['text', 'hash', 'hashsumm'])
output_file = open("need_hashes3.csv", "w")
wrtr = csv.DictWriter(output_file, fieldnames=['text', 'hash', 'hashsumm'])
